...
<header class="s-header__nav">
    <div class="wrappers">
        ...
        <div class="s-header__nav-client">
            <a href="{{route('student.pay.index')}}" class="s-header__nav-client-sum">
                <h3>Мой счет: </h3>
            ...
            <div class="s-header__nav-client-profile">
                ...
                <div class="s-header__nav-client-list display-n"><a class="s-header__nav-client-btn" href="{{route('student.edit.index')}}">
                        <p>Профиль</p></a>
