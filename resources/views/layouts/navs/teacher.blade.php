<ul class="nav flex-column">
    ...
    <li class="nav-item"><a class="nav-link @if(Route::is('teacher.tickets.*')) active @endif" href="{{route('teacher.tickets.index')}}"><i class="fa fa-info fa-lg"></i> Поддержка</a></li>
</ul>