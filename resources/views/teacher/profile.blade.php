                ...
                <div class="col-md-9">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group"><input type="text" value="{{old('lesson_price') ? old('lesson_price') : $user->lesson_price}}" placeholder="Стоиомть урока" min="0" name="lesson_price" class="form-control"></div>
                            <div class="form-group">
